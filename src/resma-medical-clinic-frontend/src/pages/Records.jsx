                   ...
                   <div className='flex justify-between items-center'>
                        ...
                        <div className='flex justify-between items-center '>
                            ...
                            {(user.role === "Admin" || user.role === "Secretary") && (
                               <NavLink to="/AddPatient" className="fw-32 font-semibold px-6 ml-1 p-2.5 text-[10px] text-white bg-[#4673FF] rounded-md transition-all duration-300 transform hover:bg-[#365ec4] hover:scale-105 hover:shadow-lg" href="">NEW PATIENT</NavLink>
                              )}
